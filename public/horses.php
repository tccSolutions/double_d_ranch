            ...
            <div class=" col-lg-12  p-4  border-bottom border-2">
                <div class='row ' style='max-height:95%;'>
                    <div class='col-lg-4 border-end ' style='height:25%'>
                        <img class='card-img border align-self-center mx-auto d-block ' <?php if ($horse->images) : ?> src=<?= $horse->images[rand(0, count($horse->images) - 1)]['url'] ?> <?php else : ?> src="https://th.bing.com/th/id/OIP.TNh845oVx3x5IyscikB2VgHaHa?w=159&h=180&c=7&r=0&o=5&pid=1.7" <?php endif ?> style="max-height:200px; width:auto;">
